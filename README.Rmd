...
res <- countBam(bamfile, param=para)
...
The SummarizedExperiment is a storage class for high-dimensional information which is tied to the same GenomicRanges across a number of different experiments (e.g., quantity of reads in fixed ranges).
